...
@section('content')
<div class="container">
    <h2 ><i class="fa  fa-credit-card-alt"></i> Checkout</h2>
    <hr>
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form method="post" id="payment-form" action="{{ route('checkout') }}">
                ...
                <button type="submit" class="btn btn-info col-md-12">Complete Order</button>
            </form>
        ...
        <div class="col-md-5">
            ...
            <table class="table  table-bordered your-order-table">
                <tr>
                    <th>Image</th>
                    <th>Details</th>
                    <th>Qty</th>
                ...
                <tr>
                    <td><img src="{{ url('/uploads/products') . '/'. $item->model->image }}" alt="" style="width: 4em"></td>
                    <td>
                        <strong>{{ $item->model->name }}</strong><br>
                        <small>{{ $item->model->description }}</small> <br>
...
@push('js')
    <script>
        ...
        var stripe = Stripe('pk_test_IouWkIHvYhIU2wnoxT2IE8MS00JYgwFdgr');
